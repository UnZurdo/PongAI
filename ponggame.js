...
var render = function () {
    ...
    document.getElementById('turn').innerHTML = ai.turn;
    document.getElementById('winsM').innerHTML = winsM;
    document.getElementById('losesM').innerHTML = losesM;
    document.getElementById('winsP').innerHTML = winsP;
    document.getElementById('losesP').innerHTML = losesP;
    document.getElementById('speed').innerHTML = speed;
    document.getElementById('set').innerHTML = number_sets;
};
...
Paddle.prototype.move = function (x, y) {
    ...
    this.x += x;
    this.y += y;
    this.x_speed = x*speed;
    this.y_speed = y*speed;
